...
/*   Updated: 2024/03/26 16:04:26 by cshingai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	insert_img(t_game *game)
{
	...
	game->img.personage_r1 = create_img
		(game->mlx, "./sprites/reborn/reborn_R1.png");
	game->img.personage_r2 = create_img
		(game->mlx, "./sprites/reborn/reborn_R2.png");
	game->img.personage_r3 = create_img
		(game->mlx, "./sprites/reborn/reborn_R3.png");
	game->img.personage_l1 = create_img
		(game->mlx, "./sprites/reborn/reborn_L1.png");
	game->img.personage_l2 = create_img
		(game->mlx, "./sprites/reborn/reborn_L2.png");
	game->img.personage_l3 = create_img
		(game->mlx, "./sprites/reborn/reborn_L3.png");
...
{
	game->img.death_msg = create_img
		(game->mlx, "./sprites/death_msg.png");
